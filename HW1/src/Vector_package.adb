...
package body Vector_package is
   ...
   begin
      if(V.Pointer /= 0) then return V.Data(1);else return 0; end if;
   end first;
   ...
   begin
      if(V.Pointer /= V.Max) then
         ...
         Ada.Text_IO.Put_Line("This vector is full");
      end if;
   ...
   begin
      if(V.Pointer /= 0) then
         ...
         Ada.Text_IO.Put_Line("The vector is empty");
      end if;
   ...
   begin
      ...
      if(size1 + size2 <= V1.Max) then
         ...
         Ada.Text_IO.Put_Line("The first vector does not have enough space!");
      end if;
   ...
   begin
      ...
      if(size + V.Pointer <= V.Max) then
         ...
         Ada.Text_IO.Put_Line("This is no enough space in vector");
      end if;
