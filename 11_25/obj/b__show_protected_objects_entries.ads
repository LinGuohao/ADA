...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_show_protected_objects_entries" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4d0ec9f6#;
   pragma Export (C, u00001, "show_protected_objects_entriesB");
   ...
   --  show_protected_objects_entries%b
