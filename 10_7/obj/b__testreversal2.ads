...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_testreversal2" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ab610192#;
   pragma Export (C, u00001, "testreversal2B");
   ...
   u00114 : constant Version_32 := 16#4b0f4089#;
   pragma Export (C, u00114, "reversal2B");
   u00115 : constant Version_32 := 16#f7cf9b40#;
   pragma Export (C, u00115, "reversal2S");
