...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_maptest" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#641c5e27#;
   pragma Export (C, u00001, "maptestB");
   ...
   u00122 : constant Version_32 := 16#25a6f3e9#;
