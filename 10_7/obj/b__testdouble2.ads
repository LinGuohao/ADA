...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_testdouble2" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#61994ac0#;
   pragma Export (C, u00001, "testdouble2B");
   ...
   u00134 : constant Version_32 := 16#2256c890#;
   pragma Export (C, u00134, "double2B");
   u00135 : constant Version_32 := 16#5cd791ae#;
   pragma Export (C, u00135, "double2S");
