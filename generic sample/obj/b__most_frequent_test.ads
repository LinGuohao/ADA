...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_most_frequent_test" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1de973f5#;
   pragma Export (C, u00001, "most_frequent_testB");
   ...
   u00114 : constant Version_32 := 16#28f464fa#;
   pragma Export (C, u00114, "most_frequentB");
   u00115 : constant Version_32 := 16#934a2b9b#;
   pragma Export (C, u00115, "most_frequentS");
