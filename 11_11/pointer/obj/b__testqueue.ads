...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_testqueue" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e371a564#;
   pragma Export (C, u00001, "testqueueB");
   ...
   u00134 : constant Version_32 := 16#9864edee#;
   pragma Export (C, u00134, "queuegenB");
   u00135 : constant Version_32 := 16#d45fde44#;
   pragma Export (C, u00135, "queuegenS");
