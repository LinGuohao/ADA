...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_testbst" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#af0bdfd1#;
   pragma Export (C, u00001, "testbstB");
   ...
   u00134 : constant Version_32 := 16#358f5cbf#;
   pragma Export (C, u00134, "binary_search_tree_packageB");
   u00135 : constant Version_32 := 16#2e0ac03c#;
   pragma Export (C, u00135, "binary_search_tree_packageS");
   ...
   --  binary_search_tree_package%s
   --  binary_search_tree_package%b
   --  testbst%b
