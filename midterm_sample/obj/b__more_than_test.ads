...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_more_than_test" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2bf44b6d#;
   pragma Export (C, u00001, "more_than_testB");
   ...
   u00134 : constant Version_32 := 16#815e9428#;
   pragma Export (C, u00134, "more_thanB");
   u00135 : constant Version_32 := 16#cd543d3c#;
   pragma Export (C, u00135, "more_thanS");
