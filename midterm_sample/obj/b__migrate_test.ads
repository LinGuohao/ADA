...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_migrate_test" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ce169569#;
   pragma Export (C, u00001, "migrate_testB");
   ...
   u00134 : constant Version_32 := 16#56efad98#;
   pragma Export (C, u00134, "migrateB");
   u00135 : constant Version_32 := 16#5b6f339e#;
   pragma Export (C, u00135, "migrateS");
